...
/// FileName: update_attendance_rule
/// Author: Jack
/// Date: 2020/12/7
/// Description:
class UpdateAttendanceRule extends StatefulWidget {
  dynamic data;
  setData(data){
    this.data = data;
  }
  @override
  _UpdateAttendanceRuleState createState() => _UpdateAttendanceRuleState();
}

class _UpdateAttendanceRuleState extends State<UpdateAttendanceRule> {
  Map ruleInfo = {};
  ...
  //初始化数据
  initData()  {
    ruleInfo["startDate"] = widget.data["inWorkTime"];
    ruleInfo["endDate"] = widget.data["outWorkTime"];
  ...
  addRule()  {
    ...
    for(var item in employList){
     ...
     AttendanceApi.updateAttRuleRequest(
      param: {
