...
class ShareShopDetailsModel {
  ...
  ShareShopDetailsModel({this.sellerLatitude, this.sellerLongitude, this.buyerAddress, this.buyerLatitude, this.buyerLongitude, this.secondHand, this.address = '', this.distance = '', this.goodsName = '', this.goodsPrice = '', this.infoPics, this.listPics, this.model = '', this.remarks = '', this.sharePrice = '', this.shopGoodsId = '', this.shopId = '', this.shopName = '', this.specName = '', this.stock = '', this.shareStock = '', this.tel = '', this.startingPrise = ''});

  ShareShopDetailsModel.fromJson(Map<String, dynamic> json):
  ...
  Map<String, dynamic> toJson() {
    ...
    data['secondHand'] = this.secondHand;
    return data;
  }
}
